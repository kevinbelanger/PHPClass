...
class TaskRegistry implements IRegistry
{	
	private static $_me;
	...
	public static function load()
    {
        if(is_null(self::$_me))
		{
            self::$_me = new TaskRegistry(IRegistry::REGISTRY_TYPE_ARRAY);
        }
        return self::$_me;
    }
	...
	public static function get($itemId)
	{
		...
		{
			throw new Exception("The item '". $itemId ."' doesn't exist into the TaskRegistry");
		}
	}
